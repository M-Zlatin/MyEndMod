...
public enum ModArmorMaterials implements ArmorMaterial {
    ENDERITE("enderite", 25, new int[] { 3, 8, 6, 3 }, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2f, 0.1f, () -> Ingredient.ofItems(ModItems.ENDERITE));
    ...
    public String getName() {
        return MyEndMod.MOD_ID + ":" + this.name;
    }
